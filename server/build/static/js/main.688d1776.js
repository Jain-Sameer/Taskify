/*! For license information please see main.688d1776.js.LICENSE.txt */
!(function () {
  "use strict";
  var e = {
      463: function (e, t, n) {
        ...
        function Ya(e) {
          ...
          function v(l, u, i, s) {
            ...
            if (g.done) return n(l, m), la && Jl(l, v), c;
            if (null === m) {
            ...
            return ("string" === typeof o && "" !== o) || "number" === typeof o
              ? ((o = "" + o),
                null !== a && 6 === a.tag
                  ...
                  : (n(r, a), ((a = js(o, r.mode, i)).return = r), (r = a)),
                u(r))
              : n(r, a);
          };
        }
        ...
        function os(e, t) {
          ...
          return (
            ...
            2 !== (e = ys(e, t)) && ((t = Vi), (Vi = n), null !== t && us(t)),
            e
          );
        }
        function us(e) {
  ...
  !(function () {
    ...
    function u() {
      ...
      function d(e, t, n, r) {
        var a = t && t.prototype instanceof b ? t : b,
          ...
          u = new O(r || []);
        return l(o, "_invoke", { value: N(e, n, u) }), o;
      }
      function p(e, t, n) {
        try {
        ...
        return function (a, o) {
          ...
          for (r.method = a, r.arg = o; ; ) {
            ...
            if ("next" === r.method) r.sent = r._sent = r.arg;
              ...
              if (l === h) throw ((l = y), r.arg);
              r.dispatchException(r.arg);
            } else "return" === r.method && r.abrupt("return", r.arg);
            l = v;
            var s = p(t, n, r);
            if ("normal" === s.type) {
              if (((l = r.done ? y : m), s.arg === g)) continue;
        ...
        if (t || "" === t) {
          ...
          if (!isNaN(t.length)) {
            var l = -1,
              a = function n() {
                for (; ++l < t.length; )
                  if (r.call(t, l)) return (n.value = t[l]), (n.done = !1), n;
              ...
              return u().wrap(function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 2:
                      return (l = e.sent), (e.next = 5), l.json();
                    case 5:
                      e.sent.acknowledged &&
                        n(function (e) {
                          return e.map(function (e) {
                            return e._id === t
                              ? p(p({}, e), {}, { status: !e.status })
                              : e;
                          });
                        });
                    case 7:
                ...
                for (;;)
                  switch ((e.prev = e.next)) {
                    case 0:
                      return (
                        (e.next = 2),
                        fetch("/api/todos/".concat(t), { method: "DELETE" })
                      );
                    case 2:
    ...
    function v() {
              ...
              u().mark(function e() {
                ...
                return u().wrap(function (e) {
                  for (;;)
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (e.next = 2), fetch("/api/todos");
                      case 2:
          ...
          u().mark(function e(t) {
            ...
            return u().wrap(function (e) {
              for (;;)
                switch ((e.prev = e.next)) {
                  case 0:
                    if ((t.preventDefault(), !(o.length > 3))) {
                      e.next = 10;
                      break;
                    }
                    return (
      ...
      return (0, h.jsxs)("main", {
        className: "container",
        children: [
          (0, h.jsx)("h1", { className: "title", children: "Taskify" }),
          (0, h.jsxs)("form", {
            className: "form",
            onSubmit: f,
            children: [
          ...
          (0, h.jsx)("div", {
            ...
            children:
              n.length > 0 &&
              n.map(function (e) {
                return (0, h.jsx)(m, { todo: e, setTodos: r }, e._id);
              }),
          }),
        ],
      });
    ...
    t.createRoot(document.getElementById("root")).render(
      (0, h.jsx)(e.StrictMode, { children: (0, h.jsx)(v, {}) })
    );
  })();
})();
//# sourceMappingURL=main.688d1776.js.map
